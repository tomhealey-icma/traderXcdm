...
public class AccountUserController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<AccountUser> getAccountUserById(@PathVariable int id) throws JsonProcessingException {
		AccountUser retVal = this.accountUserService.getAccountUserById(id);
		return ResponseEntity.ok(retVal);
	}

	@PostMapping("/")
	public ResponseEntity<AccountUser> createAccountUser(@RequestBody AccountUser accountUser) throws JsonProcessingException {
	...
	@PutMapping("/")
	public ResponseEntity<AccountUser> updateAccountUser(@RequestBody AccountUser accountUser) throws JsonProcessingException {
		return ResponseEntity.ok(this.accountUserService.upsertAccountUser(accountUser));
	}

	@GetMapping("/")
	public ResponseEntity<List<AccountUser>> getAllAccountUsers() throws JsonProcessingException {
