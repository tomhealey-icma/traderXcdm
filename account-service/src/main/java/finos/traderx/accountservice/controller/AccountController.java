...
public class AccountController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Account> getAccountById(@PathVariable int id) throws JsonProcessingException {
	...
	public ResponseEntity<Account> createAccount(@RequestBody Account account) throws JsonProcessingException {
		...
		ResponseEntity re = ResponseEntity.ok(this.accountService.upsertAccount(account));
		return re;
	}

	@PutMapping("/")
	public ResponseEntity<Account> updateAccount(@RequestBody Account account) throws JsonProcessingException {
	...
	public ResponseEntity<List<Account>> getAllAccount() throws JsonProcessingException {
		...
		return (ResponseEntity<List<Account>>) ResponseEntity.ok(this.accountService.getAllAccount());
	}
