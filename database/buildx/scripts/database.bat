...
set CLASSPATH=%APP_HOME%\lib\database.jar;%APP_HOME%\lib\h2-2.2.224.jar


@rem Execute database
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DATABASE_OPTS%  -classpath "%CLASSPATH%" org.h2.tools.Console %*
